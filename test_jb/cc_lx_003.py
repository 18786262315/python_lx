...
# i = driver.find_element_by_id("su").is_displayed()
# print(driver.find_element_by_id("su").get_attribute("su"))

# time.sleep(5)

# driver.get("http://www.w3school.com.cn/html/html_elements.asp")
