...
for i,s in phone.items():
        ...
        #进入权限管理
        time.sleep(5)
        driver.find_element_by_xpath('//*[@id="sidebar-menu"]/div/ul/li[3]').click()
        ...
        driver.find_element_by_xpath('//*[@id="sidebar-menu"]/div/ul/li[2]/ul/li').click()
        ...
        Select(driver.find_element_by_id('add-vendor')).select_by_visible_text('MixGo')


        Select(driver.find_element_by_id('add-brand')).select_by_visible_text('MixGo艺术品')


        Select(driver.find_element_by_class_name('add-category')).select_by_visible_text("房产")
        ...
        driver.find_element_by_xpath("//*[@id='form-product']/div[13]/input[2]").click()
